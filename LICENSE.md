...
<body>
  ...
  <div class="notice">
    <p><strong>Product:</strong> Thinker V1 – Research & Planning Module (Standalone)</p>
  ...
  <h2>🧩 Important Integration Status</h2>
  <p><strong>Thinker V1</strong> was developed as an <strong>independent project</strong> and was <u>not part of</u> the AutoserGPT Workstation architecture.</p>
...
The following conditions apply:</p>
  <ul>
    ...
    <li>This version is <strong>archived</strong> and no longer maintained. It is retained for historical reference only.</li>
  </ul>

  <h2>📬 Contact</h2>
  <p>To request licensing, integration partnerships, or commercial rights:</p>
  <ul>
    <li>Email: <a href="mailto:zubin@autotechserv.com">zubin@autotechserv.com</a></li>
    <li>GitHub: <a href="https://github.com/zubinqayam" target="_blank">github.com/zubinqayam</a></li>
  </ul>

  <footer>
    &copy; 2025 Zubin Qayam. All rights reserved. 
---
Unauthorized use or duplication is strictly prohibited.<br>
    Thinker V1 remains a standalone module; all future integrations will be handled via Thinker V2 and later.
  </footer>
